...
CREATE TABLE `tbl_books` (
  ...
  `b_price` decimal(5,2) unsigned DEFAULT NULL,
  PRIMARY KEY (`b_id`)
...
INSERT INTO `tbl_books` VALUES ('7783161484100','Œ «¥­ìª¨© ¯à¨­æ','€­âã ­ ¤¥ ‘¥­â-ª§î¯¥à¨',1,67.07),('9783161484100','’à¨ â®¢ à¨é ','à¨å Œ à¨ï ¥¬ àª',1,21.27);
...
-- Dump completed on 2020-04-10 20:46:19
